...
export default function Help() {
  return (
    <div className="help">
      ...
      <div className="words-help">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      ...
      Consectetur a erat nam at lectus urna duis. Iaculis eu non diam.</div>
